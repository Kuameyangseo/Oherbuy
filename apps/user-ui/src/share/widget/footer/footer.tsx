...
const Footer: React.FC = () => {
  ...
  return (
    <div className="mt-8 bg-green-700 pt-9">
      <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          <div className="md:w-[316px]">
            <h2 className="text-white font-extrabold text-[18px]">OherBuy</h2>
            ...
            <div className="mt-[18px] flex gap-4" aria-hidden>
              <a className="hover:scale-110" target="_blank" rel="noreferrer noopener" href="#">
                <img alt="facebook icon" loading="lazy" width="36" height="36" src="https://www.englishyaari.com/img/facebook.svg" />
              </a>
              <a className="hover:scale-110" target="_blank" rel="noreferrer noopener" href="#">
                <img alt="linkedin icon" loading="lazy" width="36" height="36" src="https://www.englishyaari.com/img/linkdin.svg" />
              </a>
              <a className="hover:scale-110" target="_blank" rel="noreferrer noopener" href="#">
                <img alt="instagram icon" loading="lazy" width="36" height="36" src="https://www.englishyaari.com/img/instagram1.svg" />
              </a>
              <a className="hover:scale-110" target="_blank" rel="noreferrer noopener" href="#">
                <img alt="twitter icon" loading="lazy" width="36" height="36" src="https://www.englishyaari.com/img/twitter.svg" />
              </a>
              <a className="hover:scale-110" target="_blank" rel="noreferrer noopener" href="https://www.youtube.com/">
                <img alt="youtube icon" loading="lazy" width="36" height="36" src="https://www.englishyaari.com/img/youtube.svg" />
              </a>
            </div>
          </div>
          ...
          <div className="md:w-[316px]">
            ...
            <div className="mt-[23px] flex">
              ...
              <div className="ml-[18px]">
                <a href="#" className="font-Inter text-[14px] font-medium text-[#fff]">Sub Nerul, Mumbai, India, 123456</a>
          ...
          <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
            <div>
              ...
              <ul>
                <li className="mt-[12px]"><Link href="/" className="text-white/90 hover:text-white font-inter text-[15px]">Home</Link></li>
                <li className="mt-[12px]"><Link href="/watchlist" className="text-white/90 hover:text-white font-inter text-[15px]">Watchlist</Link></li>
                <li className="mt-[12px]"><Link href="/cart" className="text-white/90 hover:text-white font-inter text-[15px]">Cart</Link></li>
                <li className="mt-[12px]"><Link href="/contact" className="text-white/90 hover:text-white font-inter text-[15px]">Contact</Link></li>
                <li className="mt-[12px]"><Link href="/terms" className="text-white/90 hover:text-white font-inter text-[15px]">Terms</Link></li>
                <li className="mt-[12px]"><Link href="/privacy" className="text-white/90 hover:text-white font-inter text-[15px]">Privacy</Link></li>
              </ul>
            </div>
            <div className="mt-6 flex flex-col gap-4 sm:mt-0">
              <p className="text-deutziawhite font-inter text-[18px] font-medium">Download the app</p>
              <div className="flex gap-4 sm:flex-col">
                <a target="_blank" rel="noreferrer noopener" href="#"><img alt="google store" loading="lazy" width="168" height="50" src="https://www.englishyaari.com/img/google-store.svg" /></a>
                <a target="_blank" rel="noreferrer noopener" href="#"><img alt="apple store" loading="lazy" width="168" height="50" src="https://www.englishyaari.com/img/apple-store.svg" /></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
          <p className="text-[10px] font-normal text-white md:text-[12px]">© Copyright {year}, All Rights Reserved by YOUR WEBSITES. PVT. LTD</p>
        </div>
      </div>
    </div>
  )
